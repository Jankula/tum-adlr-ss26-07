...
def gpu_diffusion_worker(input_queue, output_queue, experiment_name, type):
...
def main(experiment_name, model_type, split_type, object_index):
    ...
    _,_,encoder_cpu, decoder_cpu = utils.reload_model(None, None, experiment_name, model_type, device_cpu)
