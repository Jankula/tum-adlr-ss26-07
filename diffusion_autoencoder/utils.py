...
def reload_model_latent(optimizer, scheduler, experiment_name, type, device):
    ...
    decoder = Decoder(latent_dim=model_config['latent_dim'], hidden_dim=model_config['dec_hidden_dim'], embedding_dim=model_config['embedding_dim'],
